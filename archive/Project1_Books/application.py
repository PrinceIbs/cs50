...
if not os.getenv("DATABASE_URL"):
    # DATABASE_URL is an environment variable set from the command line
...
def book_page(book_isbn):
    ...
    #Goodreads data
    res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": KEY, "isbns": f"{book_isbn}"})
    # KEY is environment variable set from command line
